...
> 這篇是 [《你上一次知道自己身體真正的狀態，是什麼時候？Prysm-iO 15 秒揭開身體的抗氧化真相》](/blog/precision-health-tools/prysm-io-15sec/) 的延伸深度閱讀，如果你想先了解「為什麼要測類胡蘿蔔素」的快速版本，建議先讀。
...
**物理學家** Werner Gellermann 博士（專精雷射與光學）和 **眼科醫師** Paul S. Bernstein 醫師（視網膜專家）
...
它們會隨著血液被輸送到全身各處，並大量囤積在各個組織中。其中最大的儲存庫，就是 **人體最大的器官，皮膚**。
...
對 40 - 50 歲的壯年消費者來說，他們對健康產品的要求已根本改變：
...
在過去二十年間，他們在全球近 50 個國家部署了無數台基於高精準度拉曼雷射（RRS）的 BioPhotonic 掃描儀，透過這些儀器，累積了一個包含超過 1,000 萬人次、總數高達 **2,100 萬筆**的高純度拉曼抗氧化資料庫。

軟體工程師們將這個龐大的黃金標準資料庫，餵給了 Prysm iO 背後的 AI 演算法。

**人工智慧透過深度學習，學會了如何從 Spectral Rai 收集到的混亂、龐雜的高光譜反射數據中，精準剔除雜訊干擾，並將結果「校準」回拉曼技術應有的準確度水準。**
...
這也是為什麼我對這個工具有信心，不是因為它看起來很科技，是因為我親眼看過這段歷史。
