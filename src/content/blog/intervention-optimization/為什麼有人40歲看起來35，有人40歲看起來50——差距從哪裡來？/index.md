...
2024年發表在《Science》的一項大型研究，追蹤了近 3000 名受試者，用蛋白質組學（proteomics）測量了數千個生物標記，試圖回答：人的老化速度，有多少是命中注定的？

結論是：**壽命和老化速度約有 55% 由遺傳決定，45% 由非遺傳因素決定。**
...
最有力的天然開關是 **熱量限制（Caloric Restriction）**：從 1935 年就開始有動物實驗顯示，適度減少熱量攝取可以延長壽命，機制之一就是重新啟動 SIRT1 和 AMPK。
...
**YouthSpan** 處理的是「長壽基因的表現」——用 CRM 機制讓你的老化時鐘走慢一點，這是你剛才讀到的部分。

**R2** 處理的是「每日細胞修復的效率」——你的身體每天都在製造損傷，R2 確保這些損傷每晚被正確清除，不要帶著昨天的殘局進入明天。
...
R2 日夜節律的完整機制，在篇3「補充順序」裡有詳細說明，這裡先聚焦在兩者的角色關係。
...
準備好開始了嗎？這是我建議的進場順序：
👉 [抗發炎補充的正確順序——從地基到基因調校](/blog/anti-inflammation-supplement-order)
