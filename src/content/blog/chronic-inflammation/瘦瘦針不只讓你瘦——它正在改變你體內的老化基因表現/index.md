---
title: "瘦瘦針不只讓你瘦——它正在改變你體內的老化基因表現"
description: "GLP-1 受體促效劑的抗老機制：直接活化 IGF-1 受體、粒線體生物生成、全身性抗慢性發炎。這不是減重藥的副作用，這是它的另一個主效果——但有一個你必須知道的前提。"
pubDate: 2026-04-16
...
GLP-1 進入身體後，很快會被 DPP-4 酶分解。但這個「被分解」的過程，不是終點，是另一個機制的開始。
...
更特別的是，它在**幾乎沒有 GLP-1R 的肝臟細胞**同樣有效。
 ...
 GLP-1 藥物對粒線體的保護效果，有一部分完全繞過受體層面，直接在細胞器層次發生。
...
**粒線體生物生成**：研究顯示，長期使用 GLP-1 類似物後，細胞內粒線體品質增加約 20%，關鍵驅動因子是 **PGC-1α** 的強烈上調，PGC-1α 正是粒線體生物生成的主控轉錄因子，也是運動和熱量限制共同激活的標的。這條 AMPK → SIRT1 → PGC-1α 路徑，和你靠「少吃」或「運動」觸發的抗老機制高度重疊。
...
這不是放棄使用 GLP-1 的理由，是提醒你：**阻力訓練和足夠蛋白質攝取是必要配套，不是可選項。** 
...
這三個選項的詳細比較——包括副作用、費用、停藥後復胖——在這篇有完整說明：[打瘦瘦針前你應該先搞清楚這些事](/blog/intervention-optimization/glp1-clinical-guide-tirzepatide/)
